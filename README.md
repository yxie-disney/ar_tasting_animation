...
- 大尺寸边界试验已被实机反馈否决。当前固定名义尺寸 **95 × 210mm**，宽高约为上一版的 44%，完整原图比例不变；卡片中心在管轴远侧 55mm，底边离纸面 35mm，高于管身 29mm。另有不可见的已知尺寸试管几何体提供深度遮挡，让实物在虚拟内容之前显示；不是现场分割或任意物体深度识别。尺寸是配置值，不是重新测量过的实体打印尺寸。
