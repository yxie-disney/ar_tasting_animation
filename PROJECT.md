...
4. Current content is the unchanged original portrait tasting-card artwork on a thin 3D card standing upright BEHIND the horizontal tube. Card up is the paper's outward normal; the reading plane is perpendicular to the paper and its front faces the initial viewer. The entire virtual card clears the tube's far edge by at least 10mm; its bottom is 12mm above the paper. Its nominal dimensions are FIXED at 216 × (216 × 2480 / 1122)mm, approximately 216 × 477.4mm. The complete original texture uses unmodified UVs; no fit-to-viewport, automatic shrinkage, text reflow, source crop or generated replacement is permitted. Edges outside the view are intentional for this user-requested spatial-boundary inspection. Orientation, position and dimensions remain fixed relative to the physical card as the phone moves. Image-pose loss still hides content; this is not persistent world anchoring. The earlier botanical geometry is retained but not loaded. Dynamic asset production remains a separate future task.
