...
4. Current content is the unchanged original portrait artwork on a thin 3D card standing upright on the FIXED far side of the approved printed layout (+X), facing its QR-side viewing direction (−X). It does not choose front/back from the acquisition frame. The center is 55mm beyond the tube axis; the bottom is 35mm above paper, above the 29mm tube. User rejected 216 × 477.4mm as too large and 95 × 210mm (44%) as too small; current fixed nominal size is 144 × 318.3mm, exactly two-thirds of the large trial with original aspect preserved. There is no automatic viewport shrinkage, reflow, crop or generated replacement. An invisible 215 × Ø29mm tube proxy writes depth before virtual content; this is a known-layout approximation, not segmentation. The earlier botanical geometry remains unloaded. Dynamic asset production is separate.
